...
AvaN=nrow(AvaData)
AvaData$Gender=as.factor(AvaData$Gender)#盢┦锣摸跑计0╧1

#Validation set approach
#80%戈training set/20%validation set
...
#パvalidation setだ璸衡d=1,2,...,5程ㄎ家validation MSE
...
#パtraining set篶癹耴家
#パvalidation set璸衡d=1,2..,5家validation MSE
for(j in 1:FoldK){
...
#パ瓜浪琩outlier/influential point/high leverage point
...
vif(RegModel_K.F)#浪琩癹耴collinearity
